...
def request_ajax_data(url,session=None,data=None,headers=None):
    #print(url)
    ret =request(url,session=session,data=data,headers=headers)
    #jsonText = response.read()
    return json.loads(ret)

def request(url,session=None,data=None,headers=None):
